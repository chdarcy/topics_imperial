...
\begin{itemize}
  ...
  \item Vol-scaling, which sizes z-score MR positions in proportion to a
        rolling volatility target, improves the Sharpe ratio materially on
        spot~1Y--30Y (0.92 versus 1.14 for unrestricted MR) and reduces
        drawdown on the forward curve (94\,bps vs.\ 121\,bps for MR), but
